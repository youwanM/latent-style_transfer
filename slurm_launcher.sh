#!/bin/bash
#SBATCH --job-name=train-ddpm # nom du job
...
#SBATCH --output=ddpm-train%j.out # output file name
#SBATCH --error=ddpm-train%j.err  # error file name
...
# --model_save_dir ./vae_models-no_bias --batch_size 8 --epochs 200 --lr 1e-4 --beta 1e-5
...
--sample_dir ddpm_samples --ae_param /gpfswork/rech/gft/umh25bv/latent-style_transfer/vae_models-no_sampling/model_9.pth \
